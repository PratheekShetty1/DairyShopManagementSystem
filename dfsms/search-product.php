...
<input type="text" pattern="[A-Za-z]*" class="form-control" id="validationCustom03" placeholder="Customer Name" name="customername" required>
...
<input type="text" class="form-control"  pattern="[0-9]{10}" maxlength="10" id="validationCustom03" placeholder="Mobile Number" name="mobileno" required>
