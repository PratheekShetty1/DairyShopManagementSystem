...
<input type="email" class="form-control" id="validationCustom03" value="<?php echo $row['Email'];?>" name="emailid" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Invalid email address" required>
...
<input type="tel" class="form-control" pattern="[0-9]{10}" maxlength="10" id="validationCustom03" value="<?php echo $row['MobileNumber'];?>" name="mobilenumber" required>
